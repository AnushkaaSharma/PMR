...
contract EMRContract {
  ...
  */
  ...
  function SignupPatient(string memory _fullname,
      string memory _dob,
      SexType _sex,
      MaritalType _marital,
      string memory _email,
      uint256[] memory _medicalreport) public {
  ...
  function PatientUpdate(string memory _fullname,
      string memory _dob,
      SexType _sex,
      MaritalType _marital,
  ...
  function AppointmentAdd(uint256 _datetime, 
    AppointmentStat _stat, string memory _remark) public {
    
    require(msg.sender == patients[msg.sender].client);
    require(_datetime > block.timestamp);
  ...
  function MedicalReportAdd(string memory _docname,
    string memory _docpath,
    string memory _docdesp) public {
  ...
  function MedicalReportGet(address _addr) public view returns(uint256[] memory){
